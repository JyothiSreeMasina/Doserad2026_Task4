...
# do_save.sh
#
# Packages the Task 1 submission for upload to Grand Challenge: rebuilds
# the image, saves it as a gzipped tarball, and separately tars up
# docker/model/ (the checkpoint) as model.tar.gz -- Grand Challenge wants
# the trained weights uploaded as a distinct "Model" from the algorithm
# container itself.
